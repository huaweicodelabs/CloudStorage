...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mshowProgerss;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mshowProgerss = findViewById(R.id.showProgress);
    ...
    private void downloadFile() {
        ...
        try {
            downloadTask.addOnSuccessListener(downloadResult -> mShowResultTv.setText("download success!"))
                    ...
                    .addOnProgressListener(downloadResult -> mshowProgerss.setText(String.format("progress: %f", (downloadResult.getBytesTransferred()*1.0)/downloadResult.getTotalByteCount()*100)+"%"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
