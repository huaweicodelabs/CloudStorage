...
- (void)viewDidLoad {
    ...
    self.storage = [AGCStorage getInstanceForBucketName:@"giraffe-5dhc9"];
}
...
- (IBAction)downloadFile:(id)sender {
    AGCStorageReference *storageReference = [self.storage referenceWithPath:@"test1.jpg"];
    NSString *dirPath = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) firstObject];
    NSString *destFilePath = [dirPath stringByAppendingPathComponent:@"test1.jpg"];
